...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        #case 2, has parents
            ...
            mom_passes = passing_prob[mom]
            dad_passes = passing_prob[dad]

            if genes == 2:
                gene_prob = mom_passes * dad_passes
            elif genes == 1:
                gene_prob =(mom_passes*(1-dad_passes))+((1-mom_passes)*dad_passes)
            else:
                gene_prob = (1-mom_passes)*(1-dad_passes)
